...
import me.msile.app.androidapp.common.web.widget.BaseX5WebView;

public class BaseX5WebFragment extends BaseRecyclerFragment implements BaseX5WebView.BaseWebViewClient, WebViewHolder {

    private static final String TAG = "BaseX5WebFragment";
    ...
    protected BaseX5WebView mWebView;
    ...
    protected int getLayoutResId() {
        return R.layout.fragment_base_x5_web;
    }
    ...
    public static BaseX5WebFragment newInstance(String webUrl, boolean showProgress) {
        Bundle bundle = new Bundle();
        bundle.putString(EXTRA_WEB_URL, webUrl);
        bundle.putBoolean(EXTRA_WEB_SHOW_PROGRESS, showProgress);
        BaseX5WebFragment webFragment = new BaseX5WebFragment();
    ...
    public void loadUrl(String url) {
        if (webViewListener != null) {
            boolean b = webViewListener.onLoadUrl(url, true);
            if (b) {
                return;
            }
        }
    ...
    public void onPermissionRequest(PermissionRequest permissionRequest) {
        if (webViewListener != null && permissionRequest != null) {
    ...
    public void doUpdateVisitedHistory(WebView webView, String s, boolean b) {
        if (webViewListener != null) {
            webViewListener.doUpdateVisitedHistory(s, b);
        }
    }
